...
- [rc/](rc/): Configuration snippets sourced from [zshrc](zshrc:1) such as options, environment, and aliases. Common files include [rc/options.rc](rc/options.rc:1), [rc/env.rc](rc/env.rc:1), and [rc/alias.rc](rc/alias.rc:1) if present.
