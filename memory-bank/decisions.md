...
ADR-0002: Plugin set
- Decision: Use the portable plugins configured in [zshrc](zshrc:106): zsh-256color, ssh-agent, and uv.
- Rationale: Retain terminal color compatibility, lazy SSH-agent management, and Python environment support without loading unused terminal-specific helpers.
